...
public class CustomersApiTest {
     ...
     */
    @Test
    public void findAllCustomerPastUsageTest()  {
        String externalCustomerId = null;
        ...
        CustomerPastUsage response = api.findAllCustomerPastUsage(externalCustomerId, externalSubscriptionId, page, perPage, billableMetricCode, periodsCount).block();
     ...
     */
    @Test
    public void generateCustomerCheckoutURLTest()  {
        String externalCustomerId = null;
        GenerateCustomerCheckoutURL200Response response = api.generateCustomerCheckoutURL(externalCustomerId).block();
