...
@JsonDeserialize(
    builder = CouponObject.Builder.class
)
public final class CouponObject {
  ...
  CouponObject(Optional<String> lagoId, Optional<String> name, Optional<String> code,
      Optional<CouponType> couponType, Optional<Integer> amountCents,
      Optional<String> amountCurrency, Optional<Boolean> reusable, Optional<String> createdAt,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CouponObject && equalTo((CouponObject) other);
  }

  private boolean equalTo(CouponObject other) {
    return lagoId.equals(other.lagoId) && name.equals(other.name) && code.equals(other.code) && couponType.equals(other.couponType) && amountCents.equals(other.amountCents) && amountCurrency.equals(other.amountCurrency) && reusable.equals(other.reusable) && createdAt.equals(other.createdAt) && percentageRate.equals(other.percentageRate) && frequency.equals(other.frequency) && frequencyDuration.equals(other.frequencyDuration) && expirationAt.equals(other.expirationAt) && expiration.equals(other.expiration);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.lagoId, this.name, this.code, this.couponType, this.amountCents, this.amountCurrency, this.reusable, this.createdAt, this.percentageRate, this.frequency, this.frequencyDuration, this.expirationAt, this.expiration);
    }
  ...
  public String toString() {
    return "CouponObject{" + "lagoId: " + lagoId + ", name: " + name + ", code: " + code + ", couponType: " + couponType + ", amountCents: " + amountCents + ", amountCurrency: " + amountCurrency + ", reusable: " + reusable + ", createdAt: " + createdAt + ", percentageRate: " + percentageRate + ", frequency: " + frequency + ", frequencyDuration: " + frequencyDuration + ", expirationAt: " + expirationAt + ", expiration: " + expiration + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(CouponObject other) {
    ...
    public CouponObject build() {
      return new CouponObject(lagoId, name, code, couponType, amountCents, amountCurrency, reusable, createdAt, percentageRate, frequency, frequencyDuration, expirationAt, expiration);
    }
  }
}
