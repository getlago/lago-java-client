...
final class couponsServiceErrorDecoder implements ErrorDecoder {
  @Override
  public Exception decode(String methodKey, Response response) {
    try {
      ...
      if (methodKey.contains("apply")) {
        return decodeException(response, ApplyException.class);
      }
      if (methodKey.contains("findAllAppliedCoupons")) {
        return decodeException(response, FindAllAppliedCouponsException.class);
      }
    }
    catch (IOException e) {
    }
