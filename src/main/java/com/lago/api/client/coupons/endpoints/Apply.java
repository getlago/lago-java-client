...
public final class Apply {
  ...
  public static final class Request {
    private final AppliedCouponInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(AppliedCouponInput body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public AppliedCouponInput getBody() {
      return body;
    }
    ...
    public String toString() {
      return "Apply.Request{" + "body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(AppliedCouponInput body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      private AppliedCouponInput body;
      ...
      @Override
      public _FinalStage body(AppliedCouponInput body) {
        this.body = body;
        return this;
      }
