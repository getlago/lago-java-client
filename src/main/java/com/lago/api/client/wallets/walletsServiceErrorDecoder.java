...
final class walletsServiceErrorDecoder implements ErrorDecoder {
  @Override
  public Exception decode(String methodKey, Response response) {
    try {
      ...
      if (methodKey.contains("createWalletTransaction")) {
        return decodeException(response, CreateWalletTransactionException.class);
      }
      if (methodKey.contains("findWalletTransactions")) {
        return decodeException(response, FindWalletTransactionsException.class);
      }
    }
    catch (IOException e) {
    }
