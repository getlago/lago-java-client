...
public final class Update {
  ...
  public static final class Request {
    ...
    private final WalletUpdateInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(String id, WalletUpdateInput body, Optional<BearerAuth> authOverride) {
      this.id = id;
      this.body = body;
    ...
    public WalletUpdateInput getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(WalletUpdateInput body);
    }
    ...
    public static final class Builder implements IdStage, BodyStage, _FinalStage {
      ...
      private WalletUpdateInput body;
      ...
      @Override
      public _FinalStage body(WalletUpdateInput body) {
        this.body = body;
        return this;
      }
