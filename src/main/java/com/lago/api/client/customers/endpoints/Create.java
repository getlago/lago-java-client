...
public final class Create {
  ...
  public static final class Request {
    private final CustomerInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(CustomerInput body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public CustomerInput getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(CustomerInput body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(CustomerInput body) {
        this.body = body;
        return this;
      }
