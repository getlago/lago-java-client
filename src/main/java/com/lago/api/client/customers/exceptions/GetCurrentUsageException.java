package com.lago.api.client.customers.exceptions;
...
@JsonDeserialize(
    using = GetCurrentUsageException.Deserializer.class
)
public final class GetCurrentUsageException extends Exception {
  private final Value value;

  private int statusCode;

  private GetCurrentUsageException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetCurrentUsageException other(Object unknownValue, int statusCode) {
    return new GetCurrentUsageException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetCurrentUsageException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetCurrentUsageException> {
    @Override
    public GetCurrentUsageException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetCurrentUsageException(value, statusCode);
    }
  }
}
