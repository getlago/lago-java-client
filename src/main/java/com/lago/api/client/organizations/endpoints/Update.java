package com.lago.api.client.organizations.endpoints;
...
public final class Update {
  ...
  public static final class Request {
    private final OrganizationInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(OrganizationInput body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public OrganizationInput getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(OrganizationInput body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      private OrganizationInput body;
      ...
      @Override
      public _FinalStage body(OrganizationInput body) {
        this.body = body;
        return this;
      }
