...
@JsonDeserialize(
    builder = OrganizationInputObject.Builder.class
)
public final class OrganizationInputObject {
  ...
  OrganizationInputObject(Optional<String> webhookUrl, Optional<String> country,
      Optional<String> addressLine1, Optional<String> addressLine2, Optional<String> state,
      Optional<String> zipode, Optional<String> email, Optional<String> city,
      Optional<String> legalName, Optional<String> legalNumber, Optional<String> timezone,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof OrganizationInputObject && equalTo((OrganizationInputObject) other);
  }

  private boolean equalTo(OrganizationInputObject other) {
    return webhookUrl.equals(other.webhookUrl) && country.equals(other.country) && addressLine1.equals(other.addressLine1) && addressLine2.equals(other.addressLine2) && state.equals(other.state) && zipode.equals(other.zipode) && email.equals(other.email) && city.equals(other.city) && legalName.equals(other.legalName) && legalNumber.equals(other.legalNumber) && timezone.equals(other.timezone) && billingConfiguration.equals(other.billingConfiguration);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.webhookUrl, this.country, this.addressLine1, this.addressLine2, this.state, this.zipode, this.email, this.city, this.legalName, this.legalNumber, this.timezone, this.billingConfiguration);
    }
  ...
  public String toString() {
    return "OrganizationInputObject{" + "webhookUrl: " + webhookUrl + ", country: " + country + ", addressLine1: " + addressLine1 + ", addressLine2: " + addressLine2 + ", state: " + state + ", zipode: " + zipode + ", email: " + email + ", city: " + city + ", legalName: " + legalName + ", legalNumber: " + legalNumber + ", timezone: " + timezone + ", billingConfiguration: " + billingConfiguration + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(OrganizationInputObject other) {
    ...
    public OrganizationInputObject build() {
      return new OrganizationInputObject(webhookUrl, country, addressLine1, addressLine2, state, zipode, email, city, legalName, legalNumber, timezone, billingConfiguration);
    }
  }
}
