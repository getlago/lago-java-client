...
public final class Update {
  ...
  public static final class Request {
    ...
    private final BillableMetricInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(String code, BillableMetricInput body, Optional<BearerAuth> authOverride) {
      this.code = code;
      this.body = body;
    ...
    public BillableMetricInput getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(BillableMetricInput body);
    }
    ...
    public static final class Builder implements CodeStage, BodyStage, _FinalStage {
      ...
      private BillableMetricInput body;
      ...
      @Override
      public _FinalStage body(BillableMetricInput body) {
        this.body = body;
        return this;
      }
