package com.lago.api.client.events.exceptions;
...
@JsonDeserialize(
    using = CreateBatchEventsException.Deserializer.class
)
public final class CreateBatchEventsException extends Exception {
  private final Value value;

  private int statusCode;

  private CreateBatchEventsException(Value value, int statusCode) {
    this.value = value;
  ...
  public static CreateBatchEventsException other(Object unknownValue, int statusCode) {
    return new CreateBatchEventsException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "CreateBatchEventsException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<CreateBatchEventsException> {
    @Override
    public CreateBatchEventsException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new CreateBatchEventsException(value, statusCode);
    }
  }
}
