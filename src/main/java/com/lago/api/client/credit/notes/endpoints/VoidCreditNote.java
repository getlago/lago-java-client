...
public final class VoidCreditNote {
  private VoidCreditNote() {
  }
  ...
  public static final class Request {
    ...
    /**
     * @return ID of the existing Lago Credit note
     */
    public String getId() {
      return id;
    }
    ...
    public String toString() {
      return "VoidCreditNote.Request{" + "id: " + id + ", authOverride: " + authOverride + "}";
    }
    ...
    public static final class Builder implements IdStage, _FinalStage {
      ...
      /**
       * <p>ID of the existing Lago Credit note</p>
