...
public final class Create {
  ...
  public static final class Request {
    private final CreditNoteInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(CreditNoteInput body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public CreditNoteInput getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(CreditNoteInput body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(CreditNoteInput body) {
        this.body = body;
        return this;
      }
