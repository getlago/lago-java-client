...
@JsonDeserialize(
    using = DownloadException.Deserializer.class
)
public final class DownloadException extends Exception {
  ...
  private DownloadException(Value value, int statusCode) {
    this.value = value;
  ...
  public static DownloadException other(Object unknownValue, int statusCode) {
    return new DownloadException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "DownloadException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<DownloadException> {
    @Override
    public DownloadException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new DownloadException(value, statusCode);
    }
  }
}
