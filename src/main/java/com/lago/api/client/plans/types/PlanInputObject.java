...
@JsonDeserialize(
    builder = PlanInputObject.Builder.class
)
public final class PlanInputObject {
  ...
  private final Optional<List<Charges>> charges;

  private int _cachedHashCode;

  PlanInputObject(Optional<String> name, Optional<String> code, Optional<PlanInterval> interval,
      Optional<String> description, Optional<Integer> amountCents, Optional<String> amountCurrency,
      Optional<Double> trialPeriod, Optional<Boolean> payInAdvance,
      Optional<Boolean> billChargesMonthly, Optional<List<Charges>> charges) {
    this.name = name;
    this.code = code;
  ...
  public Optional<List<Charges>> getCharges() {
    return charges;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PlanInputObject && equalTo((PlanInputObject) other);
  }

  private boolean equalTo(PlanInputObject other) {
    return name.equals(other.name) && code.equals(other.code) && interval.equals(other.interval) && description.equals(other.description) && amountCents.equals(other.amountCents) && amountCurrency.equals(other.amountCurrency) && trialPeriod.equals(other.trialPeriod) && payInAdvance.equals(other.payInAdvance) && billChargesMonthly.equals(other.billChargesMonthly) && charges.equals(other.charges);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.name, this.code, this.interval, this.description, this.amountCents, this.amountCurrency, this.trialPeriod, this.payInAdvance, this.billChargesMonthly, this.charges);
    }
  ...
  public String toString() {
    return "PlanInputObject{" + "name: " + name + ", code: " + code + ", interval: " + interval + ", description: " + description + ", amountCents: " + amountCents + ", amountCurrency: " + amountCurrency + ", trialPeriod: " + trialPeriod + ", payInAdvance: " + payInAdvance + ", billChargesMonthly: " + billChargesMonthly + ", charges: " + charges + "}";
  }
  ...
  public static final class Builder {
    ...
    private Optional<List<Charges>> charges = Optional.empty();

    private Builder() {
    }

    public Builder from(PlanInputObject other) {
      name(other.getName());
      code(other.getCode());
    ...
    public Builder charges(Optional<List<Charges>> charges) {
      this.charges = charges;
      return this;
    }

    public Builder charges(List<Charges> charges) {
      this.charges = Optional.of(charges);
      return this;
    }

    public PlanInputObject build() {
      return new PlanInputObject(name, code, interval, description, amountCents, amountCurrency, trialPeriod, payInAdvance, billChargesMonthly, charges);
    }
  }
}
