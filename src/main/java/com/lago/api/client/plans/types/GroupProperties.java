...
@JsonDeserialize(
    builder = GroupProperties.Builder.class
)
public final class GroupProperties {
  ...
  GroupProperties(Optional<String> groupId, Optional<Map<String, Object>> values) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof GroupProperties && equalTo((GroupProperties) other);
  }

  private boolean equalTo(GroupProperties other) {
  ...
  public String toString() {
    return "GroupProperties{" + "groupId: " + groupId + ", values: " + values + "}";
  }
  ...
  public static final class Builder {
    ...
    public Builder from(GroupProperties other) {
    ...
    public GroupProperties build() {
      return new GroupProperties(groupId, values);
    }
  }
}
