...
public final class Apply {
  ...
  public static final class Request {
    private final ApplyAddOnInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(ApplyAddOnInput body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public ApplyAddOnInput getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(ApplyAddOnInput body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      ...
      @Override
      public _FinalStage body(ApplyAddOnInput body) {
        this.body = body;
        return this;
      }
