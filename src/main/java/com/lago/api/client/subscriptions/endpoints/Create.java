...
public final class Create {
  ...
  public static final class Request {
    private final SubscriptionCreateInput body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(SubscriptionCreateInput body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public SubscriptionCreateInput getBody() {
      return body;
    }
    ...
    public interface BodyStage {
      _FinalStage body(SubscriptionCreateInput body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      private SubscriptionCreateInput body;
      ...
      @Override
      public _FinalStage body(SubscriptionCreateInput body) {
        this.body = body;
        return this;
      }
