 ...
 */
@JsonPropertyOrder({
  ChargeObjectProperties.JSON_PROPERTY_GRADUATED_RANGES,
  ChargeObjectProperties.JSON_PROPERTY_GRADUATED_PERCENTAGE_RANGES,
  ChargeObjectProperties.JSON_PROPERTY_AMOUNT,
  ChargeObjectProperties.JSON_PROPERTY_FREE_UNITS,
  ChargeObjectProperties.JSON_PROPERTY_PACKAGE_SIZE,
  ChargeObjectProperties.JSON_PROPERTY_RATE,
  ChargeObjectProperties.JSON_PROPERTY_FIXED_AMOUNT,
  ChargeObjectProperties.JSON_PROPERTY_FREE_UNITS_PER_EVENTS,
  ChargeObjectProperties.JSON_PROPERTY_FREE_UNITS_PER_TOTAL_AGGREGATION,
  ChargeObjectProperties.JSON_PROPERTY_PER_TRANSACTION_MAX_AMOUNT,
  ChargeObjectProperties.JSON_PROPERTY_PER_TRANSACTION_MIN_AMOUNT,
  ChargeObjectProperties.JSON_PROPERTY_VOLUME_RANGES
})
@JsonTypeName("ChargeObject_properties")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.graduatedRanges, chargeObjectProperties.graduatedRanges) &&
        ...
        equalsNullable(this.freeUnitsPerEvents, chargeObjectProperties.freeUnitsPerEvents) &&
        equalsNullable(this.freeUnitsPerTotalAggregation, chargeObjectProperties.freeUnitsPerTotalAggregation) &&
        equalsNullable(this.perTransactionMaxAmount, chargeObjectProperties.perTransactionMaxAmount) &&
        equalsNullable(this.perTransactionMinAmount, chargeObjectProperties.perTransactionMinAmount) &&
