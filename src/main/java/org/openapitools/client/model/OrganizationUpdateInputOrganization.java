...
public class OrganizationUpdateInputOrganization {
  ...
  **/
  ...
  public OrganizationUpdateInputOrganization documentNumbering(DocumentNumberingEnum documentNumbering) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DOCUMENT_NUMBERING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDocumentNumbering(DocumentNumberingEnum documentNumbering) {
    this.documentNumbering = documentNumbering;
  }


  public OrganizationUpdateInputOrganization documentNumberPrefix(String documentNumberPrefix) {
