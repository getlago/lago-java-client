...
public class CreditNoteUpdateInput {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditNoteUpdateInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditNoteUpdateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreditNoteUpdateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreditNoteUpdateInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      CreditNoteUpdateInputCreditNote.validateJsonObject(jsonObj.getAsJsonObject("credit_note"));
  }
