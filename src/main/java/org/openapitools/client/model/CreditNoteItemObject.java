...
public class CreditNoteItemObject {
  ...
  **/
  ...
  public CreditNoteItemObject amountCurrency(String amountCurrency) {
  ...
  **/
  ...
  public CreditNoteItemObject fee(FeeObject fee) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditNoteItemObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditNoteItemObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreditNoteItemObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreditNoteItemObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      FeeObject.validateJsonObject(jsonObj.getAsJsonObject("fee"));
  }
