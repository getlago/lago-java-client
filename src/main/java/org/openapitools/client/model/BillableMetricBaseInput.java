...
public class BillableMetricBaseInput {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, billableMetricBaseInput.name) &&
        ...
        Objects.equals(this.description, billableMetricBaseInput.description) &&
        Objects.equals(this.recurring, billableMetricBaseInput.recurring) &&
        Objects.equals(this.fieldName, billableMetricBaseInput.fieldName) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to BillableMetricBaseInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillableMetricBaseInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillableMetricBaseInput is not found in the empty JSON string", BillableMetricBaseInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BillableMetricBaseInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillableMetricBaseInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillableMetricBaseInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillableMetricBaseInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillableMetricBaseInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillableMetricBaseInput.class));

       return (TypeAdapter<T>) new TypeAdapter<BillableMetricBaseInput>() {
           @Override
           public void write(JsonWriter out, BillableMetricBaseInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BillableMetricBaseInput read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BillableMetricBaseInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillableMetricBaseInput
  * @throws IOException if the JSON string is invalid with respect to BillableMetricBaseInput
  */
  public static BillableMetricBaseInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillableMetricBaseInput.class);
  }

 /**
  * Convert an instance of BillableMetricBaseInput to an JSON string
  *
  * @return JSON string
  */
