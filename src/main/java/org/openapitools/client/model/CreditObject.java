...
public class CreditObject {
  ...
  public static final String SERIALIZED_NAME_BEFORE_VAT = "before_vat";
  @SerializedName(SERIALIZED_NAME_BEFORE_VAT)
  ...
  **/
  ...
  public CreditObject amountCurrency(String amountCurrency) {
  ...
  **/
  ...
  public CreditObject beforeVat(Boolean beforeVat) {
  ...
  **/
  @javax.annotation.Nonnull
  public Boolean getBeforeVat() {
    return beforeVat;
  }


  public void setBeforeVat(Boolean beforeVat) {
    this.beforeVat = beforeVat;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lagoId, creditObject.lagoId) &&
        ...
        Objects.equals(this.beforeVat, creditObject.beforeVat) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lagoId, amountCents, amountCurrency, beforeVat, item, invoice);
  }
  ...
  public String toString() {
    ...
    sb.append("    beforeVat: ").append(toIndentedString(beforeVat)).append("\n");
  ...
  static {
    ...
    openapiRequiredFields.add("before_vat");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreditObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreditObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      CreditObjectItem.validateJsonObject(jsonObj.getAsJsonObject("item"));
      // validate the required field `invoice`
      CreditObjectInvoice.validateJsonObject(jsonObj.getAsJsonObject("invoice"));
  }
