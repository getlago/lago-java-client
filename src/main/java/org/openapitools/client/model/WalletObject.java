...
public class WalletObject {
  ...
  private List<WalletObjectRecurringTransactionRulesInner> recurringTransactionRules;
  ...
  **/
  ...
  public WalletObject recurringTransactionRules(List<WalletObjectRecurringTransactionRulesInner> recurringTransactionRules) {
    
    this.recurringTransactionRules = recurringTransactionRules;
    return this;
  }

  public WalletObject addRecurringTransactionRulesItem(WalletObjectRecurringTransactionRulesInner recurringTransactionRulesItem) {
  ...
  **/
  ...
  public List<WalletObjectRecurringTransactionRulesInner> getRecurringTransactionRules() {
    return recurringTransactionRules;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RECURRING_TRANSACTION_RULES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRecurringTransactionRules(List<WalletObjectRecurringTransactionRulesInner> recurringTransactionRules) {
    this.recurringTransactionRules = recurringTransactionRules;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lagoId, lagoCustomerId, externalCustomerId, status, currency, name, rateAmount, creditsBalance, balanceCents, consumedCredits, createdAt, hashCodeNullable(expirationAt), hashCodeNullable(lastBalanceSyncAt), hashCodeNullable(lastConsumedCreditAt), hashCodeNullable(terminatedAt), recurringTransactionRules);
  }
