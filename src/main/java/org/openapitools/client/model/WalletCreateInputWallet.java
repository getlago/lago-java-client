...
public class WalletCreateInputWallet {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, rateAmount, currency, hashCodeNullable(paidCredits), hashCodeNullable(grantedCredits), externalCustomerId, hashCodeNullable(expirationAt));
  }
