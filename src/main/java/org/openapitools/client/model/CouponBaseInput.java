...
public class CouponBaseInput {
  ...
  public CouponBaseInput() {
  }

  public CouponBaseInput name(String name) {
  ...
  **/
  ...
  public CouponBaseInput code(String code) {
  ...
  **/
  ...
  public CouponBaseInput description(String description) {
  ...
  **/
  ...
  public CouponBaseInput couponType(CouponTypeEnum couponType) {
  ...
  **/
  ...
  public CouponBaseInput amountCents(Integer amountCents) {
  ...
  **/
  ...
  public CouponBaseInput amountCurrency(Currency amountCurrency) {
  ...
  **/
  ...
  public CouponBaseInput reusable(Boolean reusable) {
  ...
  **/
  ...
  public CouponBaseInput percentageRate(String percentageRate) {
  ...
  **/
  ...
  public CouponBaseInput frequency(FrequencyEnum frequency) {
  ...
  **/
  ...
  public CouponBaseInput frequencyDuration(Integer frequencyDuration) {
  ...
  **/
  ...
  public CouponBaseInput expiration(ExpirationEnum expiration) {
  ...
  **/
  ...
  public CouponBaseInput expirationAt(OffsetDateTime expirationAt) {
  ...
  **/
  ...
  public CouponBaseInput appliesTo(CouponBaseInputAppliesTo appliesTo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CouponBaseInput couponBaseInput = (CouponBaseInput) o;
    return Objects.equals(this.name, couponBaseInput.name) &&
        Objects.equals(this.code, couponBaseInput.code) &&
        Objects.equals(this.description, couponBaseInput.description) &&
        Objects.equals(this.couponType, couponBaseInput.couponType) &&
        Objects.equals(this.amountCents, couponBaseInput.amountCents) &&
        Objects.equals(this.amountCurrency, couponBaseInput.amountCurrency) &&
        Objects.equals(this.reusable, couponBaseInput.reusable) &&
        Objects.equals(this.percentageRate, couponBaseInput.percentageRate) &&
        Objects.equals(this.frequency, couponBaseInput.frequency) &&
        Objects.equals(this.frequencyDuration, couponBaseInput.frequencyDuration) &&
        Objects.equals(this.expiration, couponBaseInput.expiration) &&
        Objects.equals(this.expirationAt, couponBaseInput.expirationAt) &&
        Objects.equals(this.appliesTo, couponBaseInput.appliesTo);
  }
  ...
  public String toString() {
    ...
    sb.append("class CouponBaseInput {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CouponBaseInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CouponBaseInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CouponBaseInput is not found in the empty JSON string", CouponBaseInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CouponBaseInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CouponBaseInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CouponBaseInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CouponBaseInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CouponBaseInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CouponBaseInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CouponBaseInput>() {
           @Override
           public void write(JsonWriter out, CouponBaseInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CouponBaseInput read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CouponBaseInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CouponBaseInput
  * @throws IOException if the JSON string is invalid with respect to CouponBaseInput
  */
  public static CouponBaseInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CouponBaseInput.class);
  }

 /**
  * Convert an instance of CouponBaseInput to an JSON string
  *
  * @return JSON string
  */
