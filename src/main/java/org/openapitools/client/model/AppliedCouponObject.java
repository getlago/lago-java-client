...
public class AppliedCouponObject {
  ...
  **/
  ...
  public AppliedCouponObject amountCurrency(String amountCurrency) {
  ...
  **/
  ...
  public AppliedCouponObject percentageRate(BigDecimal percentageRate) {
  ...
  **/
  ...
  public AppliedCouponObject frequencyDurationRemaining(Integer frequencyDurationRemaining) {
   ...
   /**
   * Get frequencyDurationRemaining
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lagoId, appliedCouponObject.lagoId) &&
        ...
        Objects.equals(this.amountCents, appliedCouponObject.amountCents) &&
        Objects.equals(this.amountCentsRemaining, appliedCouponObject.amountCentsRemaining) &&
        Objects.equals(this.amountCurrency, appliedCouponObject.amountCurrency) &&
        Objects.equals(this.percentageRate, appliedCouponObject.percentageRate) &&
        Objects.equals(this.frequency, appliedCouponObject.frequency) &&
        Objects.equals(this.frequencyDuration, appliedCouponObject.frequencyDuration) &&
        Objects.equals(this.frequencyDurationRemaining, appliedCouponObject.frequencyDurationRemaining) &&
        Objects.equals(this.expirationAt, appliedCouponObject.expirationAt) &&
        Objects.equals(this.createdAt, appliedCouponObject.createdAt) &&
        Objects.equals(this.terminatedAt, appliedCouponObject.terminatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lagoId, lagoCouponId, couponCode, lagoCustomerId, externalCustomerId, status, amountCents, amountCentsRemaining, amountCurrency, percentageRate, frequency, frequencyDuration, frequencyDurationRemaining, expirationAt, createdAt, terminatedAt);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppliedCouponObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppliedCouponObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppliedCouponObject is not found in the empty JSON string", AppliedCouponObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AppliedCouponObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppliedCouponObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppliedCouponObject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppliedCouponObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppliedCouponObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppliedCouponObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppliedCouponObject.class));

       return (TypeAdapter<T>) new TypeAdapter<AppliedCouponObject>() {
           @Override
           public void write(JsonWriter out, AppliedCouponObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppliedCouponObject read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AppliedCouponObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppliedCouponObject
  * @throws IOException if the JSON string is invalid with respect to AppliedCouponObject
  */
  public static AppliedCouponObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppliedCouponObject.class);
  }

 /**
  * Convert an instance of AppliedCouponObject to an JSON string
  *
  * @return JSON string
  */
