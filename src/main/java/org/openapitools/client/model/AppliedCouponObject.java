...
public class AppliedCouponObject {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lagoId, lagoCouponId, couponCode, couponName, lagoCustomerId, externalCustomerId, status, amountCents, amountCentsRemaining, amountCurrency, percentageRate, frequency, frequencyDuration, frequencyDurationRemaining, expirationAt, createdAt, terminatedAt);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AppliedCouponObject
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppliedCouponObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AppliedCouponObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppliedCouponObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
