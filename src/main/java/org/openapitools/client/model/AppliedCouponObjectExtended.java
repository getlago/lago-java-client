...
public class AppliedCouponObjectExtended {
  ...
  **/
  ...
  public AppliedCouponObjectExtended amountCurrency(String amountCurrency) {
  ...
  **/
  ...
  public AppliedCouponObjectExtended percentageRate(BigDecimal percentageRate) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lagoId, lagoCouponId, couponCode, lagoCustomerId, externalCustomerId, status, amountCents, amountCentsRemaining, amountCurrency, percentageRate, frequency, frequencyDuration, frequencyDurationRemaining, expirationAt, createdAt, terminatedAt, credits);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppliedCouponObjectExtended
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppliedCouponObjectExtended.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AppliedCouponObjectExtended.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppliedCouponObjectExtended` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
