...
public class CouponObject {
  ...
  **/
  ...
  public CouponObject amountCurrency(String amountCurrency) {
  ...
  **/
  ...
  public CouponObject percentageRate(BigDecimal percentageRate) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lagoId, name, code, couponType, amountCents, amountCurrency, reusable, limitedPlans, planCodes, limitedBillableMetrics, billableMetricCodes, createdAt, percentageRate, frequency, frequencyDuration, expirationAt, expiration);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CouponObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CouponObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CouponObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CouponObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
