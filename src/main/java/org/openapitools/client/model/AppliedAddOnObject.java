...
public class AppliedAddOnObject {
  ...
  **/
  ...
  public AppliedAddOnObject amountCurrency(String amountCurrency) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppliedAddOnObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppliedAddOnObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AppliedAddOnObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppliedAddOnObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
