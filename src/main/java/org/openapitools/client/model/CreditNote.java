...
public class CreditNote {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreditNote
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreditNote.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreditNote.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreditNote` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      CreditNoteObject.validateJsonObject(jsonObj.getAsJsonObject("credit_note"));
  }
