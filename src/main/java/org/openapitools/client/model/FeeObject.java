...
public class FeeObject {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lagoId, feeObject.lagoId) &&
        ...
        Objects.equals(this.lagoSubscriptionId, feeObject.lagoSubscriptionId) &&
        Objects.equals(this.lagoCustomerId, feeObject.lagoCustomerId) &&
        Objects.equals(this.externalCustomerId, feeObject.externalCustomerId) &&
        ...
        Objects.equals(this.eventTransactionId, feeObject.eventTransactionId) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to FeeObject
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeeObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FeeObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeeObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
